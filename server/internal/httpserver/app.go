...
func (a *App) buildRouter() *gin.Engine {
	...
	api.POST("/auth/resend-verify", a.handleResendVerify)
	...
	self.DELETE("/auth/pending-email", a.handleCancelEmailChange)
	...
	self.POST("/auth/google/bind", a.handleGoogleBind)
	self.POST("/auth/google/unbind", a.handleGoogleUnbind)
	self.GET("/auth/sessions", a.handleListOwnSessions)
	self.DELETE("/auth/sessions/:id", a.handleRevokeOwnSession)
	self.GET("/auth/login-logs", a.handleOwnLoginLogs)
	...
	authed.PUT("/users/batch-status", a.handleBatchUserStatus)
	...
	authed.POST("/users/:id/reset-password", a.handleResetUserPassword)
	authed.POST("/users/:id/unlock", a.handleUnlockUser)
	...
	authed.POST("/roles/:id/copy", a.handleCopyRole)
	...
	authed.GET("/online-sessions", a.handleOnlineSessions)
